...
function CareerCounselor() {
  ...
  const handleSubmitMessage = async () => {
    ...
    When responding to the student's query, only suggest minors or programs found in the above list. If the student mentions a minor or program not listed, politely explain that it is not available at ${school}. 
